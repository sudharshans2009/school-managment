  ...
  useEffect(() => {
    const checkTauri = async () => {
      ...
      if (result) {
        ...
        if (isLocalhost) {
          console.log(
            "%c🦀 TAURI DEVELOPMENT MODE",
            "color: #00ff00; font-size: 20px; font-weight: bold; background: #000; padding: 10px;",
          );
          console.log(
            "%c🌐 Using local API (localhost:3000)",
            "color: #00ff00; font-size: 14px;",
          );
          console.log(
            "%cℹ️ This is the Tauri dev window with hot reload",
          ...
          console.log(
            "%c📡 API Base: https://sms.sudharshans.me",
            "color: #00ff00; font-size: 14px;",
          );
          console.log(
            "%c✅ This is the DESKTOP APPLICATION window",
            "color: #00ff00; font-size: 14px;",
          );
        }
        ...
        console.log(
          "%c🌐 BROWSER ENVIRONMENT",
          "color: #ff9900; font-size: 16px; font-weight: bold;",
        );
        console.log(
          "%cℹ️ This is the browser tab (not the desktop app)",
          "color: #ff9900; font-size: 12px;",
        );
        console.log(
          "%cℹ️ Look for a separate 'School Management System' window",
          "color: #ff9900; font-size: 12px;",
        );
      }
