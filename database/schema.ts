...
export const circularTypeEnum = pgEnum("circular_type", [
  "general",
  "urgent",
  "academic",
  "administrative",
...
export const substituteAssignments = pgTable("substitute_assignments", {
  id: uuid("id").defaultRandom().primaryKey(),
  leaveId: uuid("leave_id").references(() => teacherLeaves.id, {
    onDelete: "cascade",
  }),
...
export const workDone = pgTable("work_done", {
  ...
  substituteAssignmentId: uuid("substitute_assignment_id").references(
    () => substituteAssignments.id,
  ),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const studentGrades = pgTable("student_grades", {
  ...
  uploadedBy: uuid("uploaded_by")
    .notNull()
    .references(() => users.id), // Teacher who uploaded
...
export const usersRelations = relations(users, ({ many }) => ({
  ...
  substituteAssignmentsAsOriginal: many(substituteAssignments, {
    relationName: "originalTeacher",
  }),
  substituteAssignmentsAsSubstitute: many(substituteAssignments, {
    relationName: "substituteTeacher",
  }),
  substituteAssignmentsAssigned: many(substituteAssignments, {
  ...
  reportCardsGenerated: many(reportCards, {
    relationName: "reportCardsGenerated",
  }),
  reportCardsFinalized: many(reportCards, {
    relationName: "reportCardsFinalized",
  }),
...
export const teacherAssignmentsRelations = relations(
  ...
  ({ one }) => ({
    ...
    classroom: one(classrooms, {
      fields: [teacherAssignments.classroomId],
      references: [classrooms.id],
    }),
...
export const homeworkSubmissionsRelations = relations(
  ...
  ({ one }) => ({
    ...
    gradedByUser: one(users, {
      fields: [homeworkSubmissions.gradedBy],
      references: [users.id],
    }),
  }),
);
...
export const feeStructuresRelations = relations(
  ...
  ({ one, many }) => ({
    classroom: one(classrooms, {
      fields: [feeStructures.classroomId],
      references: [classrooms.id],
    }),
...
export const classroomMessagesRelations = relations(
  ...
  ({ one }) => ({
    ...
    teacher: one(users, {
      fields: [classroomMessages.teacherId],
      references: [users.id],
    }),
  }),
);
...
export const calendarDaysRelations = relations(calendarDays, ({ one }) => ({
  creator: one(users, {
    fields: [calendarDays.createdBy],
    references: [users.id],
  }),
}));

export const teacherLeavesRelations = relations(
  teacherLeaves,
  ({ one, many }) => ({
    teacher: one(users, {
    ...
    approvedByUser: one(users, {
      fields: [teacherLeaves.approvedBy],
      references: [users.id],
...
export const substituteAssignmentsRelations = relations(
  substituteAssignments,
  ({ one, many }) => ({
    leave: one(teacherLeaves, {
      fields: [substituteAssignments.leaveId],
      references: [teacherLeaves.id],
    }),
    originalTeacher: one(users, {
      fields: [substituteAssignments.originalTeacherId],
      references: [users.id],
      relationName: "originalTeacher",
    }),
    substituteTeacher: one(users, {
      fields: [substituteAssignments.substituteTeacherId],
      references: [users.id],
      relationName: "substituteTeacher",
    }),
    classroom: one(classrooms, {
      fields: [substituteAssignments.classroomId],
      references: [classrooms.id],
    }),
    subject: one(subjects, {
      fields: [substituteAssignments.subjectId],
      references: [subjects.id],
    }),
    assignedByUser: one(users, {
      fields: [substituteAssignments.assignedBy],
      references: [users.id],
      relationName: "assignedBy",
    }),
    workDone: many(workDone),
...
export const workDoneRelations = relations(workDone, ({ one }) => ({
  classroom: one(classrooms, {
    fields: [workDone.classroomId],
    references: [classrooms.id],
  }),
  subject: one(subjects, {
    fields: [workDone.subjectId],
    references: [subjects.id],
  }),
  teacher: one(users, { fields: [workDone.teacherId], references: [users.id] }),
  substituteAssignment: one(substituteAssignments, {
    fields: [workDone.substituteAssignmentId],
    references: [substituteAssignments.id],
  }),
}));
...
export const examsRelations = relations(exams, ({ one, many }) => ({
  ...
  classroom: one(classrooms, {
    fields: [exams.classroomId],
    references: [classrooms.id],
  }),
  createdBy: one(users, {
    fields: [exams.createdBy],
    references: [users.id],
    relationName: "examsCreated",
  }),
  finalizedBy: one(users, {
    fields: [exams.finalizedBy],
    references: [users.id],
    relationName: "examsFinalized",
  }),
  grades: many(studentGrades),
}));
...
export const studentGradesRelations = relations(studentGrades, ({ one }) => ({
  ...
  uploadedBy: one(users, {
    fields: [studentGrades.uploadedBy],
    references: [users.id],
  }),
}));
...
export const meetingSlotsRelations = relations(
  meetingSlots,
  ({ one, many }) => ({
    teacher: one(users, {
      fields: [meetingSlots.teacherId],
      references: [users.id],
    }),
...
export const meetingBookingsRelations = relations(
  ...
  ({ one }) => ({
    ...
    parent: one(users, {
      fields: [meetingBookings.parentId],
      references: [users.id],
    }),
    student: one(students, {
      fields: [meetingBookings.studentId],
      references: [students.id],
    }),
  }),
);
...
export const circularsRelations = relations(circulars, ({ one, many }) => ({
  creator: one(users, {
    fields: [circulars.createdBy],
    references: [users.id],
  }),
  acknowledgments: many(circularAcknowledgments),
}));

export const circularAcknowledgmentsRelations = relations(
  circularAcknowledgments,
  ({ one }) => ({
    circular: one(circulars, {
      fields: [circularAcknowledgments.circularId],
      references: [circulars.id],
    }),
    user: one(users, {
      fields: [circularAcknowledgments.userId],
      references: [users.id],
    }),
  }),
);
...
export const groupMessageRecipientsRelations = relations(
  ...
  ({ one }) => ({
    message: one(groupMessages, {
      fields: [groupMessageRecipients.messageId],
...
export const admissionApplicationsRelations = relations(
  ...
  ({ one, many }) => ({
    entranceTest: one(entranceTests, {
      fields: [admissionApplications.entranceTestId],
      references: [entranceTests.id],
    }),
    reviewer: one(users, {
...
export const admissionDocumentsRelations = relations(
  ...
  ({ one }) => ({
    ...
    verifier: one(users, {
      fields: [admissionDocuments.verifiedBy],
      references: [users.id],
    }),
  }),
);

export const entranceTestsRelations = relations(
  entranceTests,
  ({ one, many }) => ({
    creator: one(users, {
      fields: [entranceTests.createdBy],
      references: [users.id],
    }),
...
export const reportCardsRelations = relations(reportCards, ({ one }) => ({
  ...
  classroom: one(classrooms, {
    fields: [reportCards.classroomId],
    references: [classrooms.id],
  }),
  ...
  finalizedByUser: one(users, {
    fields: [reportCards.finalizedBy],
    references: [users.id],
    relationName: "reportCardsFinalized",
  }),
}));

export const behaviorIncidentsRelations = relations(
  behaviorIncidents,
  ({ one, many }) => ({
    student: one(students, {
      fields: [behaviorIncidents.studentId],
      references: [students.id],
    }),
    reporter: one(users, {
      fields: [behaviorIncidents.reportedBy],
      references: [users.id],
    }),
...
export const disciplinaryActionsRelations = relations(
  ...
  ({ one }) => ({
    incident: one(behaviorIncidents, {
      fields: [disciplinaryActions.incidentId],
...
export const behaviorPointsRelations = relations(behaviorPoints, ({ one }) => ({
  student: one(students, {
    fields: [behaviorPoints.studentId],
    references: [students.id],
  }),
  awarder: one(users, {
    fields: [behaviorPoints.awardedBy],
    references: [users.id],
  }),
  incident: one(behaviorIncidents, {
    fields: [behaviorPoints.incidentId],
    references: [behaviorIncidents.id],
  }),
}));
...
export const behaviorNotesRelations = relations(behaviorNotes, ({ one }) => ({
  student: one(students, {
    fields: [behaviorNotes.studentId],
    references: [students.id],
  }),
  creator: one(users, {
    fields: [behaviorNotes.createdBy],
    references: [users.id],
  }),
}));
...
export const userPermissionsRelations = relations(
  ...
  ({ one }) => ({
    ...
    grantor: one(users, {
      ...
      references: [users.id],
      relationName: "permissionsGrantedBy",
    }),
  }),
);
